...
#define Y_DIRECTION_PIN             I2SO(4)     //////(6)
#define Y_STEP_PIN                  I2SO(3)     //////(5)
    
// Z I2S pin set
#if defined(USR_Z_MOTOR)
#define Z_DISABLE_PIN               I2SO(0) 
#define Z_DIRECTION_PIN             I2SO(6)     /////(4)
#define Z_STEP_PIN                  I2SO(5)     /////(3)
#endif
...
#define DEFAULT_X_STEPS_PER_MM 83.33
#define DEFAULT_Y_STEPS_PER_MM 79.36
#define DEFAULT_Z_STEPS_PER_MM 2500

#define DEFAULT_X_MAX_RATE 6000.0 // mm/s
#define DEFAULT_Y_MAX_RATE 6000.0 // mm/s
#define DEFAULT_Z_MAX_RATE 6000.0 // mm/s

#define DEFAULT_X_ACCELERATION 100 // mm/sec^2
#define DEFAULT_Y_ACCELERATION 100 // mm/sec^2
#define DEFAULT_Z_ACCELERATION 500.0 // mm/sec^2

#define DEFAULT_X_MAX_TRAVEL 210 // mm NOTE: Must be a positive value.
